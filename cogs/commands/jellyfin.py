...
class JellyFinCog(commands.Cog):
    ...
    async def add_to_jellyfin(self, ctx: Context, member: discord.Member, username: str = None):
        ...
        async with ctx.typing():
            ...
            # Disable remote access and enable it, since there seems to be a bug with users logging
            # in otherwise.
            ...
            try:
                ...
                embed.description = f"Please go [here]({config.jellyfin_base_url}) to login. If you require assitance, please read the guide/FAQ [here](https://wiki.anichiraku.ru/en/donators/streaming-beta)."
